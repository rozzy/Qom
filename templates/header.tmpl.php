<? _X ('header-pre') ?>
	...
	<? _T ('user-picture') ?>
	<h1 class="maintitle"><?= _A ('<a href="'. $content['blog']['href']. '"><span class="black" id="e2-blog-title">'. $content['blog']['title']. '</span></a>')?><sup><a class="rss" href="<?=@$content['blog']['rss-href']?>">РСС</a></sup></h1>
